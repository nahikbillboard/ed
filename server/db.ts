    ...
    const daily_routines: DailyRoutine[] = [
      {
        ...
        xp_earned: 220,
        streak: 7,
        notes: 'Eleanor woke up energetic and completed morning walk and yoga.',
    ...
    const notifications: NotificationItem[] = [
      {
        ...
        message: 'Eleanor checked in at 7:12 AM. Routine started smoothly with 7-day streak intact!',
        status: 'delivered',
      ...
      },
      {
        ...
        message: 'Eleanor confirmed Medicine #1 (Lisinopril 10mg) taken at 8:40 AM.',
        status: 'delivered',
    ...
    const voice_calls: VoiceCallItem[] = [
      {
        ...
        status: 'completed',
        script_content: 'Good morning Eleanor! It is 7:15 AM. The sun is up, and your morning routine is ready for you. Have a wonderful day!',
        duration_seconds: 45,
      ...
      },
      {
        ...
        trigger_source: 'scheduler',
        status: 'completed',
        script_content: 'Hello Eleanor! This is your gentle morning reminder to check Medicine Number 1 and take it with your breakfast.',
        duration_seconds: 38,
